...
export class Migration20251103225202 extends Migration {
  ...
  override async up(): Promise<void> {
    this.addSql(`create table \`profiles\` (\`id\` text not null, \`name\` text not null default 'Guest', \`total_confidence\` integer not null default 0, primary key (\`id\`));`);
    ...
    this.addSql(`create index \`goals_profile_id_index\` on \`goals\` (\`profile_id\`);`);
